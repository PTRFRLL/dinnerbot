...
const presenceUpdate = async(old, updated) => {
  try{
    ...
    if (newPresence?.details && newPresence.details.includes("Winner Winner Chicken Dinner!")) {
    ...
    if (oldPresence?.details && oldPresence.details.includes("Winner Winner Chicken Dinner!") && !newPresence.details.includes("Winner Winner Chicken Dinner!")) {
